...
namespace CRC32
{
  ...
  [[nodiscard]] inline uint32_t CalculateCRC(const uint8_t* data, std::size_t length, uint32_t previous_crc = 0) { return CRC32::Internal::crc32_fast(data, length, previous_crc); }
};
