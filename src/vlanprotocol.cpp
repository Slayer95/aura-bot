...
CIncomingVLanSearchGame *CVirtualLanProtocol::RECEIVE_VLAN_SEARCHGAME( vector<uint8_t> data )
{
...
CIncomingVLanGameInfo *CVirtualLanProtocol::RECEIVE_VLAN_GAMEINFO( vector<uint8_t> data )
{
  uint32_t ProductID_ROC = 1463898675;  // "WAR3"
  uint32_t ProductID_TFT = 1462982736;  // "W3XP"
...
bool CVirtualLanProtocol::AssignLength( vector<uint8_t> &content )
{
...
bool CVirtualLanProtocol::ValidateLength( vector<uint8_t> &content )
{
